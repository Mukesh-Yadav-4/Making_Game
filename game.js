(() => {
  ...
  function update(dt) {
    ...
    for(const o of game.obstacles){ o.y+=o.speed*dt*timeScale;o.x+=o.vx*dt*timeScale;if(!o.whooshed&&Math.abs(o.y-p.y)<42&&Math.abs((o.x+o.size/2)-p.x)<o.size*.55+65){o.whooshed=true;beep('whoosh');}if(o.type==='ship'&&(o.x<0||o.x>w-o.size))o.vx*=-1; if(overlaps(p,o,p.size*.38,o.size*.42)){ o.dead=true; hit(); } }
